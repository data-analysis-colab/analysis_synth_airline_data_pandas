...
a simulated airline database documented [here](...).
The analysis focuses on topics that receive limited attention in the corresponding [SQL-based project](...), including 
